...
class CategorysController {
    ...
    async createCategory(req, res, next) {
        try {
            ...
            await utils.add("/BoardGameCategories",req.body);
    ...
    async deleteCategory(req, res, next) {
        try {
            ...
            await utils.deleteById("/BoardGameCategories",req.params.id);
            return res.json({ msg: 'Delete data successfully.' });
        } catch (err) {
            return res
                .status(500)
    ...
    async updateCategory(req, res, next) {
        try {
            ...
            await utils.updateById("/BoardGameCategories",req.params.id,req.body)
            res.json({ msg: 'Cập nhât dữ liệu thành công' });
        } catch (err) {
            return res
                .status(500)
